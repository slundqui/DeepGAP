...
params = {
    ...
    #Inner run directory
    'runDir':          "/pv_kitti_vid_4x8_2xmlp_noreg/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    'load':            False,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/saved/pv_kitti_vid_4x8_2xmlp_noreg.ckpt",
    #Device to run on
    'device':          '/gpu:0',
    #####ISTA PARAMS######
    #Num iterations
...
tfObj = MLPVid2(params, trainDataObj.inputShape)
