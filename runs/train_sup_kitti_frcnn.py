...
trainDataObj = kittiVidPvObj(trainInputs, gts, imageFns, dncFilenames, None, shuffle=True, rangeIdx=trainRange)
testDataObj = kittiVidPvObj(trainInputs, gts, imageFns, dncFilenames, None, shuffle=True, rangeIdx=testRange)

params = {
    #Base output directory
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/sup_kitti_frcnn/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
