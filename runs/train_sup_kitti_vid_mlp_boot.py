...
stage1_params = {
    ...
    #Inner run directory
    'runDir':          "/sup_kitti_vid_4x8_boot_1_bin_run1/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
...
stage2_params = {
    ...
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/sup_kitti_vid_4x8_boot_2_bin_run1/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/sup_kitti_vid_4x8_boot_1_bin_run1/checkpoints/save-model-10100",
    #Device to run on
    'device':          '/gpu:1',
    #####ISTA PARAMS######
    #Num iterations
...
stage3_params = {
    ...
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/sup_kitti_vid_4x8_boot_3_bin_run1/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/sup_kitti_vid_4x8_boot_2_bin_run1/checkpoints/save-model-10100",
    #Device to run on
    'device':          '/gpu:1',
    #Num iterations
    'outerSteps':      302, #1000000,
