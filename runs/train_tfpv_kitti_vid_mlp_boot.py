...
#    #Inner run directory
#    'runDir':          "/tfpv_kitti_vid_4x8_boot_1_bin_4000/",
#    'tfDir':           "/tfout",
#    #Save parameters
#    'ckptDir':         "/checkpoints/",
#    'saveFile':        "/save-model",
...
#    'outDir':          "/home/slundquist/mountData/DeepGAP/",
#    #Inner run directory
#    'runDir':          "/tfpv_kitti_vid_4x8_boot_2_bin_4000/",
#    'tfDir':           "/tfout",
#    #Save parameters
#    'ckptDir':         "/checkpoints/",
#    'saveFile':        "/save-model",
...
stage3_params = {
    ...
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/tfpv_kitti_vid_4x8_boot_3_bin_2000/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/tfpv_kitti_vid_4x8_boot_2_bin_2000/checkpoints/save-model-10100",
    #Device to run on
    'device':          '/gpu:0',
    #Num iterations
