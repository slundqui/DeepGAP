...
stage1_params = {
    ...
    #Inner run directory
    'runDir':          "/eval_sup_kitti_vid_single_4x8_boot_1_bin/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/sup_kitti_vid_single_4x8_boot_1_bin/checkpoints/save-model-30100",
    #Device to run on
    'device':          '/gpu:0',
    #####ISTA PARAMS######
    #Num iterations
...
stage2_params = {
    ...
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/eval_sup_kitti_vid_single_4x8_boot_2_bin/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/sup_kitti_vid_single_4x8_boot_2_bin/checkpoints/save-model-30100",
    #Device to run on
    'device':          '/gpu:0',
    #####ISTA PARAMS######
    #Num iterations
...
stage3_params = {
    ...
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/eval_sup_kitti_vid_single_4x8_boot_3_bin/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/sup_kitti_vid_single_4x8_boot_3_bin/checkpoints/save-model-30100",
    #Device to run on
    'device':          '/gpu:0',
    #Num iterations
