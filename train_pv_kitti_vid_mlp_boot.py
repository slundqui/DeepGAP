...
#    #Inner run directory
#    'runDir':          "/pv_kitti_vid_4x8_boot_1_bin/",
#    'tfDir':           "/tfout",
#    #Save parameters
#    'ckptDir':         "/checkpoints/",
#    'saveFile':        "/save-model",
...
stage2_params = {
    ...
    'outDir':          "/home/slundquist/mountData/DeepGAP/",
    #Inner run directory
    'runDir':          "/pv_kitti_vid_4x8_boot_2_bin/",
    'tfDir':           "/tfout",
    #Save parameters
    'ckptDir':         "/checkpoints/",
    'saveFile':        "/save-model",
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/pv_kitti_vid_4x8_boot_1_bin/checkpoints/save-model-30100",
    #Device to run on
    'device':          '/gpu:0',
    #####ISTA PARAMS######
    #Num iterations
...
stage3_params = {
    ...
    #Flag for loading weights from checkpoint
    'load':            True,
    'loadFile':        "/home/slundquist/mountData/DeepGAP/pv_kitti_vid_4x8_boot_2_bin/checkpoints/save-model-30100",
    #Device to run on
    'device':          '/gpu:0',
    #Num iterations
